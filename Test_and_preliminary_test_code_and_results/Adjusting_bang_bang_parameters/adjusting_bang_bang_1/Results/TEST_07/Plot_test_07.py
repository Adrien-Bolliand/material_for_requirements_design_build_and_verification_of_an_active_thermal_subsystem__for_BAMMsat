...
name_image_output = 'Test_plot_07'
...
diff_data_mon = 23 # the timing of the monitoring data is 27 sec ahead of the pi in the pressure vessel
...
#visualisation limit
visual_x_lim_low = 1000
visual_x_lim_high = None

## Retrieve data
data_path = os.path.join(file_path, 'test_bang_bang_adjust_2020-09-11_21-19-58_TEST_07_1_data.csv')
...
monitoring_data = os.path.join(file_path, 'monitoring_vacuum_chamber_2020-09-17_07-19-44_TEST_07_1_data.csv')
