...
name_image_output = 'Test_plot_06'
...
diff_data_mon = 24 # the timing of the monitoring data is 27 sec ahead of the pi in the pressure vessel
t_offset_data = 400           # IN SECOND look for info in the readme file
...
## Retrieve data
data_path = os.path.join(file_path, 'test_bang_bang_adjust_2020-09-11_10-03-21_TEST_06_data.csv')
...
monitoring_data = os.path.join(file_path, 'monitoring_vacuum_chamber_2020-09-16_20-02-31_TEST_06_data.csv')
...
if visual_x_lim_high != None:
    ...
    ##get index of the value visual_x_lim_low on the pressure vessel data set
    i = 0
