...
## varible definition
position_high_pressure_sensor = 5
Voltage_sensor_in = 4.92 # The input voltage into the high_pressure sensor
power_voltage_in = 24   # The input voltage into the heaters
...
## Define Bang Bang
bb_disc = Bang_bang(pi,'bb_disc', heater_disc, 19, 0, 10, 80, 100, 19, 19.5, 20, 20.5, 320) # Declaration of the bang bang regulator regulating the custom heater below the disc with the default parameters
bb_fluid = Bang_bang(pi,'bb_fluid', heater_fluid, 13, 0, 30, 90, 100, 10, 12, 13, 14, 320) # Declaration of the bang bang regulator regulating the film heater on the fluidic bag support
         # Bang_bang(name (str), PWM_GPIO, heater,PWM_value_extrem_low = 0, PWM_value_low = 20, PWM__value_high = 90, PWM_value_extrem_high = 100, Thres_extrem_low = 18.5, Thres_value_low = 19, Thres_value_high = 21, Thres_extrem_high = 21.5) Try regulation in ambiant at between 18 and 22 *C 
...
with open (name+'_data.csv', 'w', newline='') as data_log:
    ...
    data_writter.writerow(['Time_log_sec',
                        ...
                        'RTD_3_1_Celsius', 'internal temp ADC1', 'internal temp ADC2', 'internal temp ADC3',
                        'Pressure_kPa',
                        ...
                        'fluid_pwm_value_ex_low', 'fluid_pwm_value_low', 'fluid_pwm_value_high', 'fluid_pwm_value_ex_hight']) # 3rd line is the data header
...
while True:
    ...
    bb_disc.update(RTD_1_3[1])  # update the status of the bang bang regulating the custom heater below the disc
    ...
    bb_fluid.update(RTD_2_2[1])  # update the status of the bang bang regulating the fluid heater
    ...
    with open (name+'_data.csv', 'a', newline='') as data_log:
        ...
        data_writter.writerow([t,
                            ...
                            RTD_3_1[1], ADC_1_temp, ADC_2_temp, ADC_3_temp,
                            high_pressure,
                            ...
                            bb_fluid.PWM_ex_low, bb_fluid.PWM_low, bb_fluid.PWM_high, bb_fluid.PWM_ex_high])
    # Print
    ...
    if RTD_1_3[0] or RTD_1_3[1] != None:
        print ('RTD1_3 '+'%.7f' % RTD_1_3[0] + ' ohm  ' + '%.2f' % RTD_1_3[1] + ' *C'+' on the surface, regulate bb disc ') # print resistance with 7 decimal and temperature with 2 decimals
    else:
        print ('No value')
    if RTD_1_2[0] or RTD_1_2[1] != None:
        print ('RTD1_2 '+'%.7f' % RTD_1_2[0] + ' ohm  ' + '%.2f' % RTD_1_2[1] + ' *C'+ ' on the surface, elec side') # print resistance with 7 decimal and temperature with 2 decimals
    else:
        print ('No value')
    if RTD_1_4[0] or RTD_1_4[1] != None:
        print ('RTD1_4 '+'%.7f' % RTD_1_4[0] + ' ohm  ' + '%.2f' % RTD_1_4[1] + ' *C'+ ' IN chamber side') # print resistance with 7 decimal and temperature with 2 decimals
    else:
        print ('No value')
    if RTD_2_1[0] or RTD_2_1[1] != None:
        print ('RTD2_1 '+'%.7f' % RTD_2_1[0] + ' ohm  ' + '%.2f' % RTD_2_1[1] + ' *C'+ ' IN chamber fluid side') # print resistance with 7 decimal and temperature with 2 decimals
    else:
        print ('No value')
    if RTD_2_4[0] or RTD_2_4[1] != None:
        print ('RTD2_4 '+'%.7f' % RTD_2_4[0] + ' ohm  ' + '%.2f' % RTD_2_4[1] + ' *C'+ ' IN chamber electronic side') # print resistance with 7 decimal and temperature with 2 decimals
    else:
        print ('No value')
    print (' ')
    ...
    if RTD_1_1[0] or RTD_1_1[1] != None:
        print ('RTD1_1 '+'%.7f' % RTD_1_1[0] + ' ohm  ' + '%.2f' % RTD_1_1[1] + ' *C'+ ' on the pi') # print resistance with 7 decimal and temperature with 2 decimals
    else:
        print ('No value')
    if RTD_2_2[0] or RTD_2_2[1] != None:
        print ('RTD2_2 '+'%.7f' % RTD_2_2[0] + ' ohm  ' + '%.2f' % RTD_2_2[1] + ' *C'+ ' on the bag, regulate bb fluid') # print resistance with 7 decimal and temperature with 2 decimals
    else:
        print ('No value')
    if RTD_2_3[0] or RTD_2_3[1] != None:
        print ('RTD2_3 '+'%.7f' % RTD_2_3[0] + ' ohm  ' + '%.2f' % RTD_2_3[1] + ' *C'+ ' on the tube') # print resistance with 7 decimal and temperature with 2 decimals
    else:
        print ('No value')
    
    print(' ')
    if RTD_3_1[0] or RTD_3_1[1] != None:
        print ('RTD3_1 '+'%.7f' % RTD_3_1[0] + ' ohm  ' + '%.2f' % RTD_3_1[1] + ' *C'+ ' in the electronic side') # print resistance with 7 decimal and temperature with 2 decimals
    else:
        print ('No value')
    if ADC_1_temp != None:
