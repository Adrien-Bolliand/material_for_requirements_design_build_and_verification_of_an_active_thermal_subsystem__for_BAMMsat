...
name_image_output = 'Test_plot_11'
...
## Retrieve data
data_path = os.path.join(file_path, 'test_bang_bang_adjust_2020-09-17_23-58-28_TEST_11_data.csv')
...
monitoring_data = os.path.join(file_path, 'monitoring_vacuum_chamber_2020-09-16_08-49-17_TEST_11_data.csv')
...
## REMOVE TEMPERATURE abberation values
threshold = 0.8
