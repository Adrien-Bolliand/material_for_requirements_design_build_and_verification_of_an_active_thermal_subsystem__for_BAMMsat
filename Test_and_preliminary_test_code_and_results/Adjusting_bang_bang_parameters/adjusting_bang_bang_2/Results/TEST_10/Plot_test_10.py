...
name_image_output = 'Test_plot_10'
## Parameter    to remove data from the begging to sync data from PRi in 1 U and in 2U
...
diff_data_mon = 13.5 # the timing of the monitoring data is 13.5 sec ahead of the pi in the pressure vessel
...
## Retrieve data
data_path = os.path.join(file_path, 'test_bang_bang_adjust_2020-09-17_22-44-48_TEST_10_data.csv')
...
monitoring_data = os.path.join(file_path, 'monitoring_vacuum_chamber_2020-09-16_07-35-34_TEST_10_data.csv')
