...
name_image_output = 'Test_plot_14'
...
## Retrieve data
data_path = os.path.join(file_path, 'test_bang_bang_adjust_2020-09-18_06-42-43_TEST_14_data.csv')
...
monitoring_data = os.path.join(file_path, 'monitoring_vacuum_chamber_2020-09-16_15-58-21_TEST_14_data.csv')
...
def filter_aberations(temp_list, threshold, nb_point_to_average):
    ...
    ## check for abberation in the all data set and MODIFY the extracted data
    ...
    if len(temp_list) == initial_list_lenght:
        ...
        print ('There has been an unknown issue flitering abberattion')
        return temp_list, nb_of_delete
...
if visual_x_lim_high != None:
    ...
    ##get index of of the itme value visual_x_lim_low on the pressure vessel data set
    i = 0
