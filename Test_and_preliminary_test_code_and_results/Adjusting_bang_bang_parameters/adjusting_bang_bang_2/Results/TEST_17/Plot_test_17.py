...
name_image_output = 'Test_plot_17'
...
## Retrieve data
data_path = os.path.join(file_path, 'test_bang_bang_adjust_2020-09-18_16-56-45_TEST_17_data.csv')
...
monitoring_data = os.path.join(file_path, 'monitoring_vacuum_chamber_2020-09-17_02-12-23_TEST_17_data.csv')
...
def filter_aberations(temp_list, threshold, nb_point_to_average):
    ...
    ## Delete potentially aberrant value at the begins of the data set
