...
name_image_output = 'Test_plot_15'
...
diff_data_mon = 13 # the timing of the monitoring data is 13 sec ahead of the pi in the pressure vessel
...
## Retrieve data
data_path = os.path.join(file_path, 'test_bang_bang_adjust_2020-09-18_10-53-33_TEST_15_data.csv')
...
monitoring_data = os.path.join(file_path, 'monitoring_vacuum_chamber_2020-09-16_20-08-49_TEST_15_data.csv')
