 ...
 # The methods of the ADS1248 class are:
    ...
    # Converstion_R_to_C(Resistance_of_an_RTD)      Using the CVM equation return a temperature value in Celcius form an RTD resistance value
...
class ADS1248:
    ...
    def __init__(self, cs_pin, Rref = 821, list_res_mis = [0,0,0,0], Vref_2 = 2.5):
        ...
        self.vref_2 = Vref_2 # value of the second reference voltage, nominaly use to read 5 V analog sensor. The reference voltage should be around 2.5 V
 ...
 #####
    ...
    def Converstion_R_to_C(self, Resistance_RTD):
        # using quadratic CVD equation working above 0 °C. Quadratic equation is prabably excessive for the experiment temperature range. linear would most likely work
    ...
    def Read_RTD(self, RTD):
        ...
        try: # if retrieve is successful convert the reading into the value of the RDT resistance in ohm
            ...
            reading = False
        self.wreg(11,current_source_2) # swape the current sources. In IDAC1 register (11) ==> set up the extitation current into AIN 0 and 1. The current that goes through the RTD is from the source 1
    ...
    def Read_internal_temperature(self): # in this configuration Can read temperature up to 49 °C. If higher, the gain shall be changed
        ...
        self.wreg(2, [0x33]) # In the MUX1 register (2) ==> the ref voltage set on the internal reference and AIN input on the internal temeperature sensor
